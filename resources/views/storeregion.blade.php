    ...
    <div class="jumbotron container">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form action="/region/addrelation" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="exampleInputPassword1">Region</label>
                        <input type="text" name='region_name' value="{{ old('region_name') }}" class="form-control"
                            id="exampleInputPassword1" placeholder="Region">
                    </div>

                    @foreach ($stores as $key => $value)
                        <div class="form-group">
                            <input type="checkbox" name="store_name[]" value="{{ $value['id'] }}">
